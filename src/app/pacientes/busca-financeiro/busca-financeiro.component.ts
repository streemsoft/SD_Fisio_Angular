...
@Component({
  selector: 'app-busca-financeiro',
  templateUrl: './busca-financeiro.component.html',
  styleUrls: ['./busca-financeiro.component.css']
})
export class BuscaFinanceiroComponent implements OnInit {
