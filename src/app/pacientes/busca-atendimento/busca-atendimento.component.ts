...
@Component({
  selector: 'app-busca-atendimento',
  templateUrl: './busca-atendimento.component.html',
  styleUrls: ['./busca-atendimento.component.css']
})
export class BuscaAtendimentoComponent implements OnInit {
  ...
  setPacKey(key:any){
      ...
      switch(this.fire.rotaDestino()){
        case('1'):
            this.router.navigate(['/atendimento/consulta/prontuario']);
      }
